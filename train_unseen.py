...
def train(rank, a, h):
     ...
     trainset = MelDataset(training_filelist, h.segment_size, h.n_fft, h.num_mels,
                              ...
                              shuffle=False if h.num_gpus > 1 else True, fmax_loss=h.fmax_for_loss, device=device, train_unseen=True)
     ...
     if rank == 0:
          validset = MelDataset(validation_filelist, h.segment_size, h.n_fft, h.num_mels,
                                   ...
                                   fmax_loss=h.fmax_for_loss, device=device, train_unseen=True)
...
def main():
     ...
     parser.add_argument('--input_training_file', default='Static/data_augment/train_nocompress.txt')
     parser.add_argument('--input_validation_file', default='Static/data/val.txt')
     parser.add_argument('--checkpoint_path', default='Static/checkpoint_unseen')
