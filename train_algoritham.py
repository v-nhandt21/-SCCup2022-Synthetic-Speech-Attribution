...
def main():
     ...
     parser.add_argument('--input_training_file', default='Static/data_augment/train_nounseen.txt')
     parser.add_argument('--input_validation_file', default='Static/data/val.txt')
     parser.add_argument('--checkpoint_path', default='Static/checkpoint_algorithm')
